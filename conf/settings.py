...
BREVO_TEMPLATE_ID_WELCOME = env.int("BREVO_TEMPLATE_ID_WELCOME", default=7)
BREVO_TEMPLATE_ID_LOGIN = env.int("BREVO_TEMPLATE_ID_LOGIN", default=5)
BREVO_TEMPLATE_ID_NEW_PRO = env.int("BREVO_TEMPLATE_ID_NEW_PRO", default=6)
BREVO_TEMPLATE_ID_NEW_TRAINING_AMBASSADOR = env.int(
    "BREVO_TEMPLATE_ID_NEW_TRAINING_AMBASSADOR", default=6
)
BREVO_TEMPLATE_ID_NEW_ENGAGEMENT = env.int("BREVO_TEMPLATE_ID_NEW_ENGAGEMENT", default=17)
