...
def test_legacy_home_page_redirects_permanently_to_home(client):
    response = client.get("/page-d-accueil-techpourtoutes-992956", follow=True)

    assert response.redirect_chain[-1] == ("/", 301)
