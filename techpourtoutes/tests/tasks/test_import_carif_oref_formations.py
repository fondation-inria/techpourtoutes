...
from techpourtoutes.tasks.import_carif_oref_formations import import_carif_oref_formations_task

SERVICE = "techpourtoutes.tasks.import_carif_oref_formations.ImportCarifOrefFormations"
