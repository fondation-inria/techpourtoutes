...
from techpourtoutes.tasks.import_onisep_formations import import_onisep_formations_task

SERVICE = "techpourtoutes.tasks.import_onisep_formations.ImportFormations"
...
def test_the_task_runs_the_import_service():
    with patch(SERVICE) as service:
        ...
        import_onisep_formations_task(sample=True)
