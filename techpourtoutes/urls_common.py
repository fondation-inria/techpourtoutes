...
urlpatterns = [
    ...
    path(
        ...
        views.pro_training_experience_info,
        name="pro_training_experience_info",
    ),
    path(
        "mon-compte/formations/pro/<uuid:pk>/modifier/",
        views.pro_training_experience_edit,
        name="pro_training_experience_edit",
    ),
    path(
    ...
    path(
        ...
        views.beneficiary_training_experience_info,
        name="beneficiary_training_experience_info",
    ),
    path(
    ...
    path(
        ...
        views.beneficiary_training_experience_delete,
