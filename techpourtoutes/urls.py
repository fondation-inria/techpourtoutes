...
urlpatterns = [
    ...
    path("mon-compte/supprimer/modal/", views.delete_account_modal, name="delete_account_modal"),
    path("mon-compte/supprimer-mon-compte", views.delete_account, name="delete_account"),
    # Static
